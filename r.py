...
bot = telebot.TeleBot('7821760192:AAGkn-HwKJARyfKQ3hopIFl42weOjCDrBZo')
...
def create_random_key():
    key = "SALAAR-" + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(10))
